...
public class InImageBasicCollapsing extends AppCompatActivity {

    private static final String TAG = InImageBasicCollapsing.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_collapsing_image);
